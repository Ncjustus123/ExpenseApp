...
render() {
   if(this.state.messageFromServer == ''){
      return (
        <div>
      <Button bsStyle="success"  onClick={this.openModal}>Add</Button>
          <Modal
...
<Link to={{pathname: '/', search: '?month='+this.state.month+'&year='+this.state.year }} style={{ textDecoration: 'none' }}>
       <Button bsStyle="danger" bsSize="mini" onClick={this.closeModal}>Close</Button>
      </Link><br/>
<fieldset>
...
<div className='button-center'>
    ...
    return (
     <div>
       <Button bsStyle="success" bsSize="small" onClick={this.openModal}>Add</Button>
       <Modal
        isOpen={this.state.modalIsOpen}
